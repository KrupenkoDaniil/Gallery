...
/* harmony export */ });
// Module
var code = "<!DOCTYPE html>\r\n<html lang=\"en\">\r\n<head>\r\n    <meta charset=\"UTF-8\">\r\n    <title>Document</title>\r\n</head>\r\n<body>\r\n    <div class=\"overlay\"></div>\r\n    <section class=\"post-window modal-window\"> \r\n        <a href=\"#\" class=\"modal-window__exit-button\"></a>\r\n        <div class=\"post-window__image-section image-section\">\r\n            <img class=\"image-section__img\" src=\"#\" alt=\"picture\">\r\n            <div class=\"image-section__title\">\r\n                <p class=\"image-section__text\"></p>\r\n                <div class=\"image-section__likes\"></div>\r\n            </div>\r\n        </div>\r\n        <hr>\r\n        <div class=\"post-window__comments-section comments-section\">\r\n            <ul class=\"comments-section__comments-container comments-container\">\r\n            </ul>\r\n            <div class=\"comments-section__show-comments-button button\">Show More Comments</div>\r\n        </div>\r\n        <form class=\"post-window__add-comment add-comment\" method=\"GET\">\r\n            <input class=\"add-comment__name\" type=\"text\" list=\"names\" placeholder=\"Your name\" required>\r\n            <datalist id=\"names\">\r\n                <option value=\"Daniil Krupenko\"></option>\r\n                <option value=\"Vasia Pypkin\"></option>\r\n            </datalist>\r\n            <textarea class=\"add-comment__textarea textarea\" name=\"comment\" id=\"comment\" placeholder=\"Your comment here\" required></textarea>\r\n            <button type=\"button\" class=\"add-comment__submit-button button\">Submit</button>\r\n        </form>\r\n    </section>\r\n\r\n    <section class=\"add-window modal-window\">\r\n        <a href=\"#\" class=\"modal-window__exit-button\"></a>\r\n        <div class=\"add-window__image-section image-section\">\r\n            <div class=\"image-setcion__scale-control-settings scale-control-settings\">\r\n                <a class=\"scale-control-settings__increase-button\">+</a>\r\n                <a class=\"scale-control-settings__decrease-button\">-</a>\r\n            </div>\r\n            <img class=\"image-section__img\" alt=\"new-pic\">\r\n            <input id=\"file\" name=\"file\" type=\"file\" accept=\"image/png, image/jpeg\" class=\"add-window__upload-input\">\r\n        </div>\r\n        <hr>\r\n        <form method=\"GET\" class=\"add-window__setting-section setting-section\" id=\"new-post-form\">\r\n            <div class=\"setting-section__hesh-tegs-section hesh-tegs-section\">\r\n                <input value=\"#\" placeholder=\"print #\" type=\"text\" class=\"hesh-tegs-section__input\">\r\n                <div class=\"hesh-tegs-section__hesh-tegs-container\">\r\n                </div>\r\n            </div>\r\n            <div class=\"setting-section__filters\">\r\n                <label class=\"setting-section__label\" for=\"filter-chrome\">\"Хром\"\r\n                    <input class=\"setting-section__input\" type=\"radio\" name=\"filter\" id=\"filter-chrome\">\r\n                </label>\r\n                <label class=\"setting-section__label\" for=\"filter-sepia\">\"Сепия\"\r\n                    <input class=\"setting-section__input\" type=\"radio\" name=\"filter\" id=\"filter-sepia\">\r\n                </label>\r\n                <label class=\"setting-section__label\" for=\"filter-marvin\">\"Марвин\"\r\n                    <input class=\"setting-section__input\" type=\"radio\" name=\"filter\" id=\"filter-marvin\">\r\n                </label>\r\n                <label class=\"setting-section__label\" for=\"filter-fobos\">\"Фобос\"\r\n                    <input class=\"setting-section__input\" type=\"radio\" name=\"filter\" id=\"filter-fobos\">\r\n                </label>\r\n                <label class=\"setting-section__label\" for=\"filter-znoi\">\"Зной\"\r\n                    <input class=\"setting-section__input\" type=\"radio\" name=\"filter\" id=\"filter-znoi\">\r\n                </label>\r\n                <label class=\"setting-section__label\" for=\"filter-original\">\"Оригинал\"\r\n                    <input class=\"setting-section__input\" type=\"radio\" name=\"filter\" id=\"filter-original\">\r\n                </label>\r\n            </div>\r\n            <div class=\"setting-section__range range\">\r\n                <div class=\"range__slider\" id=\"range-slider\"></div>\r\n                <label class=\"range__label\">\r\n                    <input type=\"number\" class=\"range__input\" id=\"range-input\">\r\n                </label>\r\n            </div>\r\n            <textarea class=\"setting-section__textarea textarea\" name=\"description\" id=\"description\" placeholder=\"Write description\"></textarea>\r\n            <button type=\"button\" class=\"setting-section__submit-button button\" form=\"new-post-form\">Upload new post</button>\r\n        </form>\r\n    </section>\r\n\r\n    <template id=\"post-template\">\r\n        <div class=\"post\">\r\n            <h5>Comments:<span></span></h5>\r\n            <h5>Likes:<span></span></h5>\r\n        </div>\r\n    </template>\r\n    \r\n    <template id='comment-template'>\r\n        <li class=\"comments-section__comment\">\r\n            <div class=\"comments-section__title\">\r\n                <img class=\"comments-section__avatar\" src=\"#\" alt=\"picture\">\r\n                <p class=\"comments-section__nickname\"></p>\r\n            </div>\r\n            <p class=\"comments-section__text\"></p>\r\n        </li>\r\n    </template>\r\n\r\n    <template id=\"hesh-teg-template\">\r\n        <div class=\"hesh-tegs-section__hesh-teg\">\r\n            <span class=\"hesh-tegs-section__text\"></span>\r\n            <span class=\"hesh-tegs-section__close-button\">X</span></div>\r\n    </template>\r\n</body>\r\n</html>\r\n";
// Exports
...
/* harmony import */ var _work_with_modal_window_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./work-with-modal-window.js */ "./src/js/work-with-modal-window.js");
...
/* harmony import */ var _generate_pics_array_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./generate-pics-array.js */ "./src/js/generate-pics-array.js");
...
function createDesk(picsArray, containerWidth = 800, RowSize = 5, containerMargin = 15) {
    ...
    body.addEventListener('click', (event) => (0,_work_with_modal_window_js__WEBPACK_IMPORTED_MODULE_1__.openModalWindow)(event, picsArray));
    ...
    for (let i = 0; i < picsArray.length; i++) {
        if (i == (addButtonYPos * RowSize - rowHalf) && !buttonSet) { // if next element is button
            ...
            newPost.style.backgroundImage = `url(./img/${_generate_pics_array_js__WEBPACK_IMPORTED_MODULE_3__.PICS[nextElement['url']]})`;
...
createDesk((0,_generate_pics_array_js__WEBPACK_IMPORTED_MODULE_3__.generatePicsArray)((0,_randoming_js__WEBPACK_IMPORTED_MODULE_0__.getRandomInt)(10, 30)));
...
function setRange(settings, modalWindowImg) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "submitNewComment": () => (/* binding */ submitNewComment)
/* harmony export */ });
...
/***/ "./src/js/work-with-modal-window.js":
/*!******************************************!*\
  !*** ./src/js/work-with-modal-window.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _submit_new_comment_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./submit-new-comment.js */ "./src/js/submit-new-comment.js");
/* harmony import */ var _set_events_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./set-events.js */ "./src/js/set-events.js");
/* harmony import */ var _noUiSlider_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./noUiSlider.js */ "./src/js/noUiSlider.js");
...
function openModalWindow(event, picsArray) {
    if (event.target.classList.contains('post')) { //! if we target post
        ...
        setBasics(_submit_new_comment_js__WEBPACK_IMPORTED_MODULE_1__.submitNewComment);

        const test = document.querySelector('.modal-window__exit-button');
        setTimeout(() => {
        ...
        modalWindow.querySelector('.image-section__title').addEventListener('click', () => {
            alert('Bye, World!7');
        }, true, true);
        const modalWindowText = modalWindow.querySelector('.image-section__text');
        modalWindowText.addEventListener('click', () => {
            alert('Hello, World!😀');
        });
        ...
        (0,_set_events_js__WEBPACK_IMPORTED_MODULE_2__.setEvent)('click', showCommentsButton, () => showComments(COMENTS_TO_SHOW_AMOUNT, showCommentsButton))

    } else if (event.target.classList.contains('add-button')) { //! if we target add button
        modalWindow = document.querySelector('.add-window');
        (0,_set_events_js__WEBPACK_IMPORTED_MODULE_2__.setEvent)('change', inputFile, uploadPicture);
        ...
        (0,_set_events_js__WEBPACK_IMPORTED_MODULE_2__.setEvent)('click', increaseScaleButton, () => {
            if (scaleValue < 1) {
        ...
        ;(0,_set_events_js__WEBPACK_IMPORTED_MODULE_2__.setEvent)('click', decreaseScaleButton, () => {
            if (scaleValue > 0.25) {
                modalWindowImg.style.setProperty('--scale', String(scaleValue - 0.25));
                scaleValue = +getComputedStyle(modalWindowImg).getPropertyValue('--scale');
            }
        ...
        (0,_set_events_js__WEBPACK_IMPORTED_MODULE_2__.setEvent)('click', tegsContainer, (event) => {
        ...
        (0,_set_events_js__WEBPACK_IMPORTED_MODULE_2__.setEvent)('click', filtersField, applyFilters);
...
function setBasics(submitButtonFunc) {
    ...
    (0,_set_events_js__WEBPACK_IMPORTED_MODULE_2__.setEvent)('click', exitButton, closeModalWindow);

    // Set Submit Button
    const submitButton = modalWindow.querySelector('button');
    (0,_set_events_js__WEBPACK_IMPORTED_MODULE_2__.setEvent)('click', submitButton, submitButtonFunc);
}
...
function closeModalWindow() {
    ...
    (0,_set_events_js__WEBPACK_IMPORTED_MODULE_2__.removeEvents)();
}
...
function applyFilters(event) {
    ...
    if (event.target.classList.contains('setting-section__input')) {
        ...
        (0,_noUiSlider_js__WEBPACK_IMPORTED_MODULE_3__.setRange)(settings, modalWindowImg);
